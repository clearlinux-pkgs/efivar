...
Source0  : https://github.com/rhboot/efivar/archive/39/efivar-39.tar.gz
Summary  : UEFI Variable Management
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720025189
...
/usr/lib64/libefiboot.so.1.39
/usr/lib64/libefisec.so.1
/usr/lib64/libefisec.so.1.39
/usr/lib64/libefivar.so.1
/usr/lib64/libefivar.so.1.39
